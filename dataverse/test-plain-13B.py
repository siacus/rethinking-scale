...
# nohup python -u test-plain-13B.py > log-plain13B.txt &!
...
# "TheBloke/llama-2-13b-chat.q4_K_M.gguf" 
...
results_df.to_csv('classification_results-13B-' + 'NO-FT' + '.csv', index=False)
