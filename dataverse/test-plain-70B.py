...
# nohup python -u test-plain-70B.py > log-plain70B.txt &!
...
# "TheBloke/llama-2-70b-chat.q4_K_M.gguf" 
...
results_df.to_csv('classification_results-70B-' + 'NO-FT' + '.csv', index=False)
